#!/usr/bin/env python3
"""
Рендерит pages/consent.html через Django и сохраняет как docs/consent/index.html.
Перезаписывает пути /static/ → /sib_khvoinik_test/static/ и внутренние ссылки.

Запуск из корня проекта:
  python3 scripts/export_consent_to_docs.py
"""
...
def main() -> None:
    ...
    from pages.data import CONSENT_PAGE

    html = render_to_string("pages/consent.html", CONSENT_PAGE)
    ...
    out = ROOT / "docs/consent/index.html"
