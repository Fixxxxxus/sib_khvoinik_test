...
# Кнопка «Написать в MAX». Ссылки по номеру телефона у MAX нет, поэтому
# стоит тот же адрес компании в MAX, что и на основном сайте (решение Стаса
# 14.09.2026). Пусто - кнопки на страницах нет.
OPT_MAX_URL = "https://max.ru/join/UcCEFlabfpAocHobifXghtEecgUghhCLy6gD6vAHMXM"
