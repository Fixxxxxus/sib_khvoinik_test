...
# Диалог в MAX с владельцем оптового номера. Ссылки по номеру телефона у MAX
# нет (только https://max.ru/u/<хеш> из профиля), поэтому адрес приносит
# менеджер. Пусто - кнопки «Написать в MAX» на страницах нет.
OPT_MAX_URL = ""
